...
const Recommendation = ({ type }) => {
  ...
  const img =
    type === "user"
      ? "https://images.pexels.com/photos/5797991/pexels-photo-5797991.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=250"
      : type === "popular"
  ...
  return (
    <div className="recommendation">
      ...
      <img className="rightImg" src={img} width="500" height="250" alt="" />
    </div>
  );
};
